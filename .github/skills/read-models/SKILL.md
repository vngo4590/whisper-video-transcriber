---
name: read-models
description: Explain src/models.py — every enum, dataclass, and app-wide constant. Use when adding a ClipMode, AspectRatio, AnalysisStrategy, or any shared constant.
---
