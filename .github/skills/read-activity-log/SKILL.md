...
description: Explain the Activity Log panel and the cooperative cancellation system (threading.Event, OperationCancelledError, log levels). Use when working on logging, progress reporting, or Cancel behaviour.
---
