---
name: read-file-handler
description: Explain src/transcription/file_handler.py — transcript file I/O and output naming. Use when changing where or how transcripts are saved.
---
