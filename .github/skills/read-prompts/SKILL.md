---
name: read-prompts
description: Explain the Claude prompt templates under prompts/ and how each is loaded and assembled. Use when tuning prompt wording or tracing which file feeds a given feature.
---
